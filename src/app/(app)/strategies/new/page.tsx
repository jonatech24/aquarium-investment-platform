...
export default function NewStrategyPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Add 'import backtrader as bt' if not present
      let finalCode = result.strategyCode;
      if (!finalCode.includes('import backtrader as bt')) {
          finalCode = 'import backtrader as bt\n\n' + finalCode;
      }
